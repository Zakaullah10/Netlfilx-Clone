...
import { Hs1, block4, logo } from "./asset";
...
export function Home1() {
  return (
    <div className="bg-black ">
      ...
      >
        <div className="w-[100%] flex justify-around items-center text-[2vw] text-white">
          ...
          <NavLink className="xs:text-[12px] md:text-[20px]" to="/tv">
            TV SHOW
          </NavLink>
          <NavLink className="xs:text-[12px] md:text-[20px]" to="/movie">
            MOVIES
          </NavLink>
          <NavLink className="xs:text-[12px] md:text-[20px]" to="/mylist">
            MY LIST
          </NavLink>
        </div>
      </div>
